...
train_csv = pd.read_csv("../input/movie-sentiment-with-bert/MovieData/train.tsv", sep='\t')
test_csv = pd.read_csv("../input/movie-sentiment-with-bert/MovieData/test.tsv", sep='\t')
train_csv.head(50)
# %%
test_csv.head()
# %%
...
tokenizer = AutoTokenizer.from_pretrained("../input/movie-sentiment-with-bert/bert-base-uncased")

pretrain_model = BertForSequenceClassification.from_pretrained("../input/movie-sentiment-with-bert/bert-base-uncased", num_labels=num_classes)
